  ...
  ref_d.on("value", function(snapshot) {
    //if(printed == false)
    {
      ...
      for (id in value) {
        ...
        //   nameBtn <span class="badge badge-light">4</span>
        // </button>
        ...
        var plike = document.createElement('button');
        plike.className = "btn btn-success";
        let likeCount = document.createElement('span');
        likeCount.className = "badge badge-light";
        var likeSpan = document.createTextNode(0);
        likeCount.appendChild(likeSpan);
        plike.appendChild(likeCount);
        plike.id = fileName + "\n" + id;

        var pdislike = document.createElement('button');
        pdislike.className = "btn btn-danger";
        let dislikeCount = document.createElement('span');
        dislikeCount.className = "badge badge-light";
        var dislikeSpan = document.createTextNode(0);
        dislikeCount.appendChild(dislikeSpan);
        pdislike.appendChild(dislikeCount);
        pdislike.id = fileName + "\n" + id;
        ...
        /* Appends 1 to like count display */
        plike.addEventListener("click", function(event) {
        ...
        /* Appends 1 to dislike count display */
        pdislike.addEventListener("click", function(event) {
